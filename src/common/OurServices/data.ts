...
export const ourServicesData = [
    {
        ...
        text: `Aconselhamos, desenvolvemos, e implementamos planos de comunicação e imagem sustentáveis, tendo em conta a dimensão e grupo alvo da empresa ou organizações. Temos, também, soluções eficazes para gestão de crises de comunicação. A boa reputação é deveras valiosa, sobretudo quando a capitalizamos.
        Criamos e gerimos websites e redes sociais institucionais. Também damos treinamento para o fortalecimento de departamentos de comunicação para que os técnicos e gestores possam produzir conteúdo audiovisual de alta qualidade ao nível de aspectos gráficos; exploração do marketing digital pleno e das múltiplas vantagens dos “media digitais”, como alternativa para os media tradicionais.
        `,
        icon: 1,
    },
    {
        title: "Monitoria e avaliação mediática",
        text: `Saiba o que os meios de comunicação estão a falar sobre a sua empresa e como estão a falar. Seja devido ao tempo operacional demandado dos seus colaboradores, ou pela falta de base para a execução da monitoria, ninguém tem tempo para ler tudo. Portanto, contratar uma empresa para fazer isso é garantir matéria-prima, banco de dados, busca e recuperação de informação sobre a sua marca, empresa, ou negócio.
        Por meio da “Media Coding”, a Ariella monitora mais de 20 canais, entre jornais, Rádio, TV, portais e sites de notícias. Com este serviço, ficará a saber: quais são os veículos nos quais a instituição tem maior aceitação; quais são os assuntos que rendem mais pautas; e como os jornalistas utilizam o material encaminhado pela assessoria. E por via destes dados sua empresa poderá gerir melhor a relação com os media e seus clientes ou grupo-alvo, para além de ensaiar novas formas de atingir o seu público.
        `,
        icon: 2,
    },
    {
        title: "Estúdio de fotografias",
        text: `Concebemos e produzimos material fotográfico dentro e fora de estúdio. Temos os mais modernos equipamentos para fotografar	ensaios pré-nupciais; foto modelagem; fotos corporativas; bem como cobertura fotográfica de conferências, casamentos, aniversários e outros eventos sociais. Connosco a sessão fotográfica é como você sempre sonhou. Dispomos, também, de equipamento para produção de vídeo-clips, vídeos para seminários, e eventos sociais. `,
        icon: 3,
    },
    {
        title: "Assistência técnica especializada",
        text: `
            Temos uma equipa preparada para elaboração de documentos estratégicos de empresas, instituições, ou organizações. Nos dias de hoje não dá mais para “caminhar tacteando”, e Ariella Boats auxilia a sua organização a delinear estratégias claras para abordar a caminhada rumo aos seus objectivos. Ainda neste âmbito, Ariella faz pesquisas e organiza eventos públicos.
            Ariella dá, ainda, assistência na realização de Webniarsʼs (seminários através de internet) combinando ferramentas de comunicação como Youtube, Facebook, Instagram, Zoom, Teams, Skype, entre outras.
        `,
        icon: 4,
    },
    {
        title: "Produção televisiva",
        text: `
        Oferecemos serviço de aconselhamento na produção de pauta de programas televisivos, bem como projecção e produção de programas de televisão para empresas e organizações. Ter um programa televisivo ou alimentar um programa de televisão com conteúdos é bastante importante para tornar notáveis as actividades da sua empresa ou organização. A Ariella tem uma equipa preparada para de modo pormenorizado projectar e implementar de forma sustentável a produção televisiva.  `,
        icon: 5,
    },
    {
